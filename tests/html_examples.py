...
"""
valid_chunk_3 = """• <b>Artificial Intelligence:</b> Programs that learn, adapt, and sometimes surprise their creators.
• <b>Quantum Computing:</b> New paradigms for solving currently intractable problems.
• <b>No-Code/Low-Code:</b> Empowering more people to harness computational power.
...
---"""
valid_chunk_3_remove_leading_brakes = """• <b>Artificial Intelligence:</b> Programs that learn, adapt, and sometimes surprise their creators.
• <b>Quantum Computing:</b> New paradigms for solving currently intractable problems.
• <b>No-Code/Low-Code:</b> Empowering more people to harness computational power.
...
long_code_input = """Intro text before code block one.
...
Ending text after code blocks.
"""

expected_550 = """CHUNK1
Intro text before code block one.
...
END
CHUNK3
<pre><code class="language-python">print('line 30')
print('line 31')
print('line 32')
print('line 33')
print('line 34')
...
END
CHUNK5
<pre><code class="language-python">print('b2 line 26')
print('b2 line 27')
print('b2 line 28')
print('b2 line 29')
print('b2 line 30')
